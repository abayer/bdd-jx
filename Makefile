...
test-import: info
	JX_BDD_IMPORTS=node-http,spring-boot-rest-prometheus,spring-boot-http-gradle,golang-http-from-jenkins-x-yml $(GINKGO) -p test/_import --slowSpecThreshold=$(SLOW_SPEC_THRESHOLD)
